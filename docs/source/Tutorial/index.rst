...
* `scBOND usage <scBOND_usage.ipynb>`_
* `scBOND_Aug using augmentation with cell-type labels <scBOND_aug_usage.ipynb>`_
...
* `Unpaired data translation using <scBOND_for_single_modal.ipynb>`_
